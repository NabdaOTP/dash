...
export default function SubscribePage() {
  ...
  // Load planId + ensure instance token is active
  useEffect(() => {
    if (!instanceId) {
    ...
    const init = async () => {
      try {
        // 1. Select the instance to set the correct scoped token
        ...
        toast.error(err.message || "Failed to prepare subscription");
      } finally {
        setLoadingPlans(false);
      }
    };
