...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  const dashboard = (await import(`../../messages/${locale}/dashboard.json`))
    .default;
  const instances = (await import(`../../messages/${locale}/instances.json`))
    .default;
  const messages = (await import(`../../messages/${locale}/messages.json`))
    .default;
  const billing = (await import(`../../messages/${locale}/billing.json`))
    .default;
  const settings = (await import(`../../messages/${locale}/settings.json`))
    .default;
  const apiDocs = (await import(`../../messages/${locale}/apiDocs.json`))
    .default;
